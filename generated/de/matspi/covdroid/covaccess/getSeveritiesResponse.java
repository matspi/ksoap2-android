...
public class getSeveritiesResponse extends SoapObjectWrapper {

      public static final String NAMESPACE = "http://ws.coverity.com/v2";
    public getSeveritiesResponse(SoapObject soapObject) {
    super(soapObject);
  }
  public static final String RETURN  = "return";

  public getSeveritiesResponse ( String[] _return ) {
    this(new SoapObject("http://ws.coverity.com/v2", "getSeveritiesResponse"));
