...
public class getActionsResponse extends SoapObjectWrapper {

      public static final String NAMESPACE = "http://ws.coverity.com/v2";
    public getActionsResponse(SoapObject soapObject) {
    super(soapObject);
  }
  public static final String RETURN  = "return";

  public getActionsResponse ( String[] _return ) {
    this(new SoapObject("http://ws.coverity.com/v2", "getActionsResponse"));
