...
public class getDefectStatusesResponse extends SoapObjectWrapper {

      public static final String NAMESPACE = "http://ws.coverity.com/v2";
    public getDefectStatusesResponse(SoapObject soapObject) {
    super(soapObject);
  }
  public static final String RETURN  = "return";

  public getDefectStatusesResponse ( String[] _return ) {
    this(new SoapObject("http://ws.coverity.com/v2", "getDefectStatusesResponse"));
