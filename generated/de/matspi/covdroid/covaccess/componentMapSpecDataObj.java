...
public class componentMapSpecDataObj extends SoapObjectWrapper {

      public static final String NAMESPACE = "http://ws.coverity.com/v2";
    public componentMapSpecDataObj(SoapObject soapObject) {
    super(soapObject);
  }
  public static final String COMPONENTMAPNAME  = "componentMapName";
  ...
  public componentMapSpecDataObj ( String componentMapName,componentPathRuleDataObj[] componentPathRules,componentDataObj[] _components,componentDefectRuleDataObj[] defectRules,String _description ) {
    this(new SoapObject("http://ws.coverity.com/v2", "componentMapSpecDataObj"));
    addProperty(COMPONENTMAPNAME, componentMapName);
  ...
  public String getcomponentMapName() {
    Object tmp = getProperty(COMPONENTMAPNAME);
    if ( tmp == null ) {
       return null;
    }
